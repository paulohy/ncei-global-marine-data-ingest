# ncei_arctic_cruise_example Ingestion Pipeline

The ncei_arctic_cruise_example ingestion pipeline was created from a cookiecutter template. This README file contains
